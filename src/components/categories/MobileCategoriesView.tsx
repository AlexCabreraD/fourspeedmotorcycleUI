            ...
            <div className='relative h-96 sm:h-112 overflow-hidden'>
              <OptimizedCategoryImage
                src={
                  ...
                  '/images/assets/engine-performance-placeholder.jpg'
                }
                alt={
            ...
            <div className='relative h-96 sm:h-112 overflow-hidden'>
              <OptimizedCategoryImage
                src={
                  ...
                  '/images/assets/suspension-handling-placeholder.jpg'
                }
                alt={
            ...
            <div className='relative h-96 sm:h-112 overflow-hidden'>
              <OptimizedCategoryImage
                src={
                  ...
                  '/images/assets/wheels-tires-placeholder.jpg'
                }
                alt={
                  categories.find((cat) => cat.slug === 'wheels-tires')?.name || 'Wheels & Tires'
                }
                quality={75}
                className='object-cover group-hover:scale-105 transition-transform duration-500'
                sizes='100vw'
            ...
            <div className='relative h-96 sm:h-112 overflow-hidden'>
              <OptimizedCategoryImage
                src={
                  ...
                  '/images/assets/brakes-drivetrain-placeholder.jpg'
                }
                alt={
      ...
      <div className='relative bg-steel-50 py-16 sm:py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-steel-600 text-lg mb-8 max-w-3xl mx-auto'>
            Browse our complete catalog of motorcycle parts and accessories, or get expert help
            finding the perfect components for your ride.
          </p>
