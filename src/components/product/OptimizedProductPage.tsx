...
const ProductBreadcrumb = React.memo(
  ({ productName, selectedItem }: { productName: string; selectedItem: WPSItem | null }) => (
    <nav className='flex items-center space-x-3 text-sm py-4'>
      <Link
        href='/'
        className='text-steel-600 hover:text-primary-600 transition-colors font-medium px-3 py-1.5 rounded-lg hover:bg-primary-50'
      >
        Home
      </Link>
    ...
    <div className='min-h-screen bg-steel-50'>
      ...
      <div className='bg-white border-b border-steel-200 sticky top-0 z-40'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <ProductBreadcrumb productName={product.name} selectedItem={selectedItem} />
        </div>
      </div>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
        ...
        <div>
          <OptimizedProductTabs product={product} selectedItem={selectedItem} />
        </div>
      </div>
    </div>
  )
