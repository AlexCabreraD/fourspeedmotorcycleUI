            ...
            <div className='relative w-48 h-48 bg-steel-50 flex-shrink-0'>
              ...
              <div className='absolute top-2 left-2 flex flex-col gap-1'>
                ...
                {!hasImages && !imageLoading && (
                  <div className='bg-steel-500 text-white text-xs px-2 py-1 rounded'>No Image</div>
                )}
              </div>
            </div>
            ...
            <div className='flex-1 p-6 flex flex-col justify-between'>
              <div>
                ...
                <p className='text-steel-600 text-sm line-clamp-2 mb-4'>
                  High-quality {product.product_type?.toLowerCase()} designed for performance and
                  durability.
                </p>
              </div>
    ...
    <Link href={`/product/${product.product_id}?item=${product.id}`} className='block'>
      <div className='bg-white border border-steel-200 rounded-lg overflow-hidden hover:shadow-card-hover transition-all duration-300 group cursor-pointer'>
        ...
        <div className='p-4'>
          ...
          {/* Add to Cart Button */}
          <button onClick={handleAddToCart} className='w-full btn btn-primary btn-sm'>
            Add to Cart
          </button>
        </div>
      </div>
