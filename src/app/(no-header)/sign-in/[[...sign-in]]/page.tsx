...
import { ArrowLeft, Shield, Zap, Clock, ArrowRight } from 'lucide-react'
          ...
          <div className={`flex flex-col justify-between p-16 xl:p-24 text-white h-full transition-all duration-1500 ${isLoaded ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
            ...
            <div className="max-w-2xl space-y-8">
              <h1 className="text-6xl xl:text-8xl font-black leading-[0.9] tracking-tight">
                ...
                <span className="block text-white/90 text-2xl font-light tracking-wider mt-4">TO YOUR GARAGE</span>
              </h1>
              
              <div className="w-24 h-1 bg-orange-500"></div>
              
              <p className="text-xl xl:text-2xl text-white/90 leading-relaxed font-light max-w-lg">
                Access your performance parts, track orders, and discover the latest gear engineered for riders who demand excellence.
              </p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">Instant access to your saved preferences</p>
                  </div>
                </div>
              ...
              <div className="flex items-center space-x-4 p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl">
                ...
                <span className="text-white/80 font-medium">Powered by WPS Distribution - Your trusted parts supplier</span>
              </div>
            </div>
          </div>
        </div>
