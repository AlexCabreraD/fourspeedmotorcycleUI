...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (ccLastFour) updateData.ccLastFour = ccLastFour
    if (defaultWarehouse) updateData.defaultWarehouse = defaultWarehouse
    if (defaultShipTo) updateData.defaultShipTo = defaultShipTo
