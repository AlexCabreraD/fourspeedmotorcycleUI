      ...
      try {
        ...
        if (user) {
          ...
          if (response.ok) {
            ...
            const matchingOrder = ordersData.orders.find(
              (order: WPSOrder) =>
      ...
      <div className='min-h-screen bg-steel-50 flex items-center justify-center'>
        <div className='text-center max-w-md mx-auto p-6'>
          ...
          <p className='text-steel-600 mb-6'>
            {orderData.error || "We couldn't find details for this order."}
          </p>
          <Link
            href='/'
    ...
    <div className='min-h-screen bg-steel-50 py-16'>
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          ...
          <h1 className='text-3xl font-display font-bold text-steel-900 mb-4'>Order Confirmed!</h1>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              ...
              <div>
                ...
                <div className='text-steel-600'>
                  ...
                  <p>
                    {wpsOrder.shipping_address.city}, {wpsOrder.shipping_address.state}{' '}
                    {wpsOrder.shipping_address.zip_code}
                  </p>
              ...
              <div>
                ...
                <div className='text-steel-600'>
                  ...
                  {wpsOrder.customer_phone && <p>{wpsOrder.customer_phone}</p>}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='p-6'>
            <div className='space-y-4'>
              {wpsOrder.items.map((item, index) => (
                <div
                  key={item.id || index}
                  className='flex justify-between items-center border-b border-steel-100 pb-4 last:border-b-0 last:pb-0'
                >
            ...
            <div className='border-t border-steel-200 mt-6 pt-6'>
              <div className='space-y-2'>
                ...
                <div className='flex justify-between text-steel-600'>
                  <span>Shipping</span>
                  <span>
                    {wpsOrder.shipping_amount === 0
                      ? 'FREE'
                      : formatCurrency(wpsOrder.shipping_amount)}
                  </span>
                </div>
                <div className='flex justify-between text-steel-600'>
                  <span>Tax</span>
            ...
            <div className='flex items-start'>
              ...
              <div>
                ...
                <p className='text-steel-600 text-sm'>
                  Your order is being processed and will be shipped from our warehouse within 1-2
                  business days.
                </p>
              </div>
            </div>
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8'>
          ...
          <p className='text-blue-800 text-sm mb-4'>
            ...
            <strong>{wpsOrder.po_number}</strong>
          </p>
