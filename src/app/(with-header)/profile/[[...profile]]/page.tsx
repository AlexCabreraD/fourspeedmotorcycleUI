        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-steel-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-steel-700 mb-2">First Name</label>
                  {isEditing ? (
                    <input
                      type="text"
                ...
                <div>
                  ...
                  {isEditing && (
                    <p className="text-xs text-steel-500 mt-1">Email changes require verification</p>
                  )}
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-steel-700 mb-2">Phone Number</label>
                  {isEditing ? (
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-steel-700 mb-2">Member Since</label>
                  <div className="p-3 bg-steel-50 rounded-lg border border-steel-200 flex items-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-steel-200">
                  <div>
                    ...
                    <p className="text-sm text-steel-600">Receive updates about your orders and promotions</p>
                  </div>
                ...
                <div className="flex items-center justify-between py-3 border-b border-steel-200">
                  <div>
                    ...
                    <p className="text-sm text-steel-600">Get text updates about shipping and delivery</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      type="checkbox" 
                ...
                <div className="flex items-center justify-between py-3">
                  <div>
                    ...
                    <p className="text-sm text-steel-600">Receive news about new products and special offers</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      type="checkbox" 
                ...
                return (
                  ...
                  >
                    <Icon className={`flex-shrink-0 -ml-1 mr-3 h-5 w-5 ${
                      activeTab === item.id ? 'text-primary-500' : 'text-steel-400 group-hover:text-steel-500'
                    }`} />
