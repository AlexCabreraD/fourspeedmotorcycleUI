...
function CartItem({
  ...
  const { imageUrl, loading: imageLoading } = useItemImage(item, 'card')
        ...
        <div className='flex-1 min-w-0'>
          <div className='flex items-start justify-between'>
            <div className='flex-1'>
              <h3 className='text-lg font-semibold text-steel-900 mb-2'>{item.name}</h3>
          ...
          <div className='flex items-center justify-between mt-4'>
            <div className='text-xl font-bold text-primary-600'>{formatPrice(item.list_price)}</div>
              ...
              <div className='flex items-center border border-steel-300 rounded-lg'>
                <button
                  ...
                  className={`p-2 transition-colors ${
                    item.quantity <= 1 ? 'text-steel-300' : 'text-steel-600 hover:bg-steel-50'
                  }`}
                >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
          ...
          <div className='bg-white rounded-2xl shadow-sm p-12 text-center'>
            ...
            <p className='text-steel-600 mb-8'>
              Looks like you haven't added any motorcycle parts yet. Start exploring our collection!
            </p>
          ...
          <div className='lg:col-span-1'>
            <div className='bg-white rounded-2xl shadow-sm p-6 sticky top-8'>
              ...
              <div className='mt-8 space-y-3'>
                <Link href='/checkout' className='w-full btn btn-primary btn-lg text-center block'>
                  Proceed to Checkout
                </Link>
              ...
              <div className='mt-6 text-center'>
                <p className='text-xs text-steel-500'>Secure checkout with SSL encryption</p>
              </div>
            </div>
          </div>
        </div>
