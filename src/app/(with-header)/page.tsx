...
export const metadata: Metadata = {
  ...
  description:
    'Discover high-quality motorcycle parts from leading brands. Performance parts, accessories, and expert support.',
}
        ...
        <div className='w-1/2 bg-white flex items-center'>
          <div className='p-16 lg:p-24'>
            ...
            <p className='text-xl text-steel-600 leading-relaxed mb-8 max-w-lg'>
              Every part we sell is carefully selected by motorcycle experts who understand the
              demands of performance riding. Quality isn't just a promise—it's our standard.
            </p>
          ...
          <div className='bg-white/95 backdrop-blur-sm w-full transform -skew-y-2 origin-bottom-left p-24 pb-32'>
            <div className='transform skew-y-2 max-w-4xl'>
              ...
              <p className='text-xl text-steel-600 mb-8 max-w-3xl leading-relaxed'>
                From weekend warriors to professional racers, our parts deliver the performance you
                need when it matters most. Every component tested under real-world conditions.
              </p>
      ...
      <div className='relative h-screen'>
        ...
        <div className='relative h-full flex items-center justify-center'>
          <div className='bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-16 max-w-2xl text-center'>
            <h2 className='text-5xl font-display font-black text-white mb-6'>Ready to Ride?</h2>
