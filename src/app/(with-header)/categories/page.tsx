        ...
        <div className="relative h-full flex items-center">
          <div className="w-full px-8 lg:px-16">
            <div className="max-w-4xl">
              ...
              <h1 className="text-8xl md:text-9xl font-display font-black text-white mb-8 leading-[0.9]">
                Every
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-red-500 to-orange-600">
                  Detail
                </span>
                <span className="block text-6xl md:text-7xl opacity-70">Matters</span>
              </h1>
            </div>
          </div>
        </div>
