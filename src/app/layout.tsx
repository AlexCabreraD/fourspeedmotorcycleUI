...
export const metadata: Metadata = {
  ...
  description: "Shop premium motorcycle parts, accessories, and gear from top brands. Fast shipping, expert support, and competitive prices for all your motorcycle needs.",
  keywords: "motorcycle parts, motorcycle accessories, motorcycle gear, bike parts, motorcycle equipment",
